# Reference implementation TOMP API - adaption for MaaS NRW

## MaaS NRW adaptions

All MaaS NRW adaptions are desribed in the [MaaS Definitions Repository](https://github.com/maas-nrw/maas-nrw-definitions/tree/main#usage-of-the-tomp-api)
